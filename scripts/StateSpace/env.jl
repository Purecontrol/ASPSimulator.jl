using ASM1Simulator, DifferentialEquations, Dates

DEFAULT_INFLUENT_FILE_PATH = joinpath(dirname(pathof(ASM1Simulator)), "../..", "data", "external/influent_files/dryinfluent.ascii")
...
function reset!(env::ODECore; init_state=Nothing, params_vec=Nothing, influent_file_path=DEFAULT_INFLUENT_FILE_PATH)
    ...
    default_p, default_state_init = ASM1Simulator.Models.get_default_parameters_asm1(influent_file_path=influent_file_path)
